...
//   goodsUrl: 'https://img.alicdn.com/tfscom/i1/1581756766/TB2TF0ch0zJ8KJjSspkXXbF7VXa_!!1581756766.jpg_180x180xzq90.jpg_.webp'
// }];
// const listitems = goodsinfos.map((goodsinfos) =>
//   <Goodsinfo 
//     title={goodsinfos.title}
//     introduction={goodsinfos.introduction}
//     comment={goodsinfos.comment}
//     goodsUrl={goodsinfos.goodsUrl}
//   />
// )
// function Centeryhh() {
//   return (
...
class Centeryhh extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      goodsInfo: []
